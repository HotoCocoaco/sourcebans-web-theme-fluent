...
<div class="layout_box margin-bottom">
  <div class="layout_box_title flex flex-jc:space-between flex-ai:center">
    <h2><i class="fa-solid fa-face-angry"></i> 最新增加的封禁</h2>
    <span style="text-align: right;">总计封禁: {$total_bans}</span>
  </div>
      ...
      <table>
        <thead>
          <tr>
			...
			<th style="width: 28%" class="text:left">名字</th>
            <th style="width: 28%">时长</th>
          </tr>
        </thead>
        <tbody>
...
<div class="flex flex-ai:start flex-jc:space-bwtween m:flex-fd:column">
  <div class="layout_box flex:11 margin-right margin-bottom">
    <div class="layout_box_title flex flex-jc:space-between flex-ai:center">
      <h2><i class="fa-solid fa-volume-xmark"></i> 最新添加交流限制</h2>
      <span style="text-align: right;">总计限制: {$total_comms}</span>
    </div>
  ...
  <div class="layout_box flex:11 margin-bottom">
    <div class="layout_box_title flex flex-jc:space-between flex-ai:center">
      <h2><i class="fa-solid fa-hand"></i> 最新被限制的玩家</h2>
      <span style="text-align: right;">总计停止: {$total_blocked}</span>
    </div>
